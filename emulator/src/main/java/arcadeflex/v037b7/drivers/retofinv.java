...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.retofinv.*;
    ...
    public static WriteHandlerPtr retofinv_protection_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if ((cpu0_me800_last & 0x80) != 0) {
                cpu0_me000 = (char) data;
                cpu0_me800_last = 0;
                return;
            } else if (data < 0x10) {
                switch (data) {
                    case 0x01:
                        cpu0_me000 = (char) (((cpu0_me000 >> 3) & 3) + 1);
                        break;
                    case 0x02:
