...
public class rockrage {
    ...
    public static WriteHandlerPtr rockrage_bankswitch_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr rockrage_sh_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr rockrage_VLM5030_busy_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return (VLM5030_BSY() != 0 ? 1 : 0);
        }
    };

    public static WriteHandlerPtr rockrage_speech_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static RomLoadPtr rom_rockrage = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_LOAD("620k06.15g", 0x000000, 0x20000, BADCRC(0xc0e2b35c));
            /* tiles */
