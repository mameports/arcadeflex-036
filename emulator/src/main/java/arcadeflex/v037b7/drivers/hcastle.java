...
import static gr.codebb.arcadeflex.v036.vidhrdw.hcastle.*;
...
public class hcastle {
    ...
    public static WriteHandlerPtr hcastle_bankswitch_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr hcastle_soundirq_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_cause_interrupt(1, Z80_IRQ_INT);
        }
    };

    public static WriteHandlerPtr hcastle_coin_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
