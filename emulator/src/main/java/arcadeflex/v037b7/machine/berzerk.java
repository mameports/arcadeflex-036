...
import arcadeflex.v037b7.generic.fucPtr.InitMachinePtr;
import arcadeflex.v037b7.generic.fucPtr.InterruptPtr;
import arcadeflex.v037b7.generic.fucPtr.ReadHandlerPtr;
import arcadeflex.v037b7.generic.fucPtr.WriteHandlerPtr;
...
public class berzerk {
    ...
    public static WriteHandlerPtr berzerk_irq_enable_w
            = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr berzerk_nmi_enable_w
            = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            nmi_enabled = 1;
        }
    ...
    public static WriteHandlerPtr berzerk_nmi_disable_w
            = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            nmi_enabled = 0;
        }
    ...
    public static ReadHandlerPtr berzerk_nmi_enable_r
            = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr berzerk_nmi_disable_r
            = new ReadHandlerPtr() {
        public int handler(int offset) {
            nmi_enabled = 0;
            return 0;
    ...
    public static ReadHandlerPtr berzerk_led_on_r
            = new ReadHandlerPtr() {
        public int handler(int offset) {
            //set_led_status(0, 1);
    ...
    public static ReadHandlerPtr berzerk_led_off_r
            = new ReadHandlerPtr() {
        public int handler(int offset) {
            //set_led_status(0, 0);
    ...
    public static ReadHandlerPtr berzerk_voiceboard_r
            = new ReadHandlerPtr() {
        public int handler(int offset) {
