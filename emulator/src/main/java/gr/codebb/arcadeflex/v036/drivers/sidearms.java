...
public class sidearms {
    ...
    public static WriteHandlerPtr sidearms_bankswitch_w = new WriteHandlerPtr() {
    ...
    public static ReadHandlerPtr turtship_read_ports = new ReadHandlerPtr() {
    ...
    static MemoryReadAddress turtship_readmem[]
            = {
                ...
                new MemoryReadAddress(0xe800, 0xe807, turtship_read_ports),
    ...
    public static GameDriver driver_dyger = new GameDriver("1989", "dyger", "sidearms.java", rom_dyger, null, machine_driver_turtship, input_ports_dyger, null, ROT270, "Philko", "Dyger", GAME_NO_COCKTAIL);
}
