...
public class dynduke {
    ...
    public static UBytePtr dynduke_shared_ram = new UBytePtr();

    /**
     * ************************************************************************
     */
    public static ReadHandlerPtr dynduke_shared_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return dynduke_shared_ram.read(offset);
        }
    };
    public static WriteHandlerPtr dynduke_shared_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            dynduke_shared_ram.write(offset, data);
        }
    };

    public static ReadHandlerPtr dynduke_soundcpu_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int erg, orig;
            orig = seibu_shared_sound_ram.read(offset);

            /* Small kludge to allows coins with sound off */
            if (offset == 4 && (Machine.sample_rate == 0) && (readinputport(4) & 1) == 1) {
                return 1;
            }
 ...
 /*#endif*/
    ...
    static RomLoadPtr rom_dynduke = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_LOAD_EVEN("dd2.cd7", 0x0a0000, 0x10000, 0x7e51af22);
            ROM_LOAD_ODD("dd3.ef8", 0x0c0000, 0x20000, 0xa56f8692);
            ROM_LOAD_EVEN("dd4.ef7", 0x0c0000, 0x20000, 0xee4b87b3);

            ROM_REGION(0x100000, REGION_CPU2);/* v30 sub cpu */
            ROM_LOAD_ODD("dd5.p8", 0x0e0000, 0x10000, 0x883d319c);
            ROM_LOAD_EVEN("dd6.p7", 0x0e0000, 0x10000, 0xd94cb4ff);
    ...
    static RomLoadPtr rom_dbldyn = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_LOAD_ODD("dd1.cd8", 0x0a0000, 0x10000, 0xa5e2a95a);
            ROM_LOAD_EVEN("dd2.cd7", 0x0a0000, 0x10000, 0x7e51af22);
            ROM_LOAD_ODD("3.8e", 0x0c0000, 0x20000, 0x9b785028);
            ROM_LOAD_EVEN("4.7e", 0x0c0000, 0x20000, 0x0d0f6350);

            ROM_REGION(0x100000, REGION_CPU2);/* v30 sub cpu */
            ROM_LOAD_ODD("5.8p", 0x0e0000, 0x10000, 0xea56d719);
            ROM_LOAD_EVEN("6.7p", 0x0e0000, 0x10000, 0x9ffa0ecd);
