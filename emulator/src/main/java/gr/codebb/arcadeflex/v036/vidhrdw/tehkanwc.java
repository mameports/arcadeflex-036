...
public class tehkanwc
{
	...
	public static VhStartPtr tehkanwc_vh_start = new VhStartPtr() { public int handler() 
	{
		...
		if ((tmpbitmap1 = osd_new_bitmap(2 * Machine.drv.screen_width, Machine.drv.screen_height,Machine.scrbitmap.depth)) == null)
		{
	...
	public static VhUpdatePtr tehkanwc_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
