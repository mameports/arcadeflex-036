...
public class system1 {
    ...
    public static WriteHandlerPtr system1_paletteram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            UBytePtr palette = new UBytePtr(palette_lookup, data * 3);
            int r, g, b;
    ...
    public static WriteHandlerPtr system1_videomode_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (errorlog != null && ((data & 0xef) != 0)) {
                fprintf(errorlog, "videomode = %02x\n", data);
            }
    ...
    public static ReadHandlerPtr GetSpriteBottomY = new ReadHandlerPtr() {
        public int handler(int spr_number) {
    ...
    static void RenderSprite(osd_bitmap bitmap, int spr_number) {
        ...
        for (Row = 0; Row < Height; Row++) {
            ...
            Col = 0;
            while (Col < 256) /* this is only a safety check, */ /* drawing is stopped by color == 15 */ {
                int color1, color2;
    ...
    public static void system1_compute_palette() {
        ...
        for (i = 0; i < 32; i++) {
            UBytePtr reg = new UBytePtr();//unsigned char *reg;
            int top, bottom;
    ...
    public static WriteHandlerPtr system1_videoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr wbml_bg_bankselect_r = new ReadHandlerPtr() {
        public int handler(int offset) {
