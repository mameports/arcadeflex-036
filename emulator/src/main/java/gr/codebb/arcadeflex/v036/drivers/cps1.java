 ...
 *
 * TODO: - Finish player controls in wof, dino - Finish 3rd 4th player controls,
 * 3rd 4th coin input, lockout counter in slammast, mbomber
 *
 **************************************************************************
 */
...
import static gr.codebb.arcadeflex.v036.sound.qsound.*;
...
public class cps1 {
    ...
    public static ReadHandlerPtr cps1_input3_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr cps1_snd_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (errorlog != null && (data & 0xfe) != 0) {
                fprintf(errorlog, "%04x: write %02x to f004\n", cpu_get_pc(), data);
            }
        }
    };

    public static WriteHandlerPtr cps1_sound_fade_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cps1_sound_fade_timer = data;
        }
    };

    public static ReadHandlerPtr cps1_snd_fade_timer_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return cps1_sound_fade_timer;
        }
    };

    public static ReadHandlerPtr cps1_input_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr cps1_player_input_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr forgottn_dial_0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return ((readinputport(6) - dial[0]) >> (4 * offset)) & 0xff;
        }
    };

    public static ReadHandlerPtr forgottn_dial_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return ((readinputport(7) - dial[1]) >> (4 * offset)) & 0xff;
        }
    };

    public static WriteHandlerPtr forgottn_dial_0_reset_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            dial[0] = readinputport(6);
        }
    };

    public static WriteHandlerPtr forgottn_dial_1_reset_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            dial[1] = readinputport(7);
        }
    };

    public static WriteHandlerPtr cps1_coinctrl_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr cpsq_coinctrl2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if ((data & 0xff000000) == 0) {
    ...
    public static ReadHandlerPtr cps1_protection_ram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            /*
    ...
    public static InterruptPtr cps1_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    public static ReadHandlerPtr qsound_sharedram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return qsound_sharedram.read(offset / 2) | 0xff00;
        }
    };

    public static WriteHandlerPtr qsound_sharedram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            qsound_sharedram.write(offset / 2, data);
        }
    };

    public static WriteHandlerPtr qsound_banksw_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /*
     ...
     * EEPROM ======
     *
     * The EEPROM is accessed by a serial protocol using the register 0xf1c006
     *
     *******************************************************************
     */
    ...
    public static nvramPtr qsound_nvram_handler = new nvramPtr() {
    ...
    public static nvramPtr pang3_nvram_handler = new nvramPtr() {
        public void handler(Object file, int read_or_write) {
            if (read_or_write != 0) {
                EEPROM_save(file);
            } else {
    ...
    public static ReadHandlerPtr cps1_eeprom_port_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return EEPROM_read_bit();
        }
    };

    public static WriteHandlerPtr cps1_eeprom_port_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /*
             bit 0 = data
             bit 6 = clock
    ...
    static MemoryReadAddress cps1_readmem[]
            = {
                ...
                new MemoryReadAddress(0x8001fc, 0x8001fc, cps1_input2_r), /* Input ports (SF Rev E) */
    ...
    static MemoryWriteAddress cps1_writemem[]
            = {
                ...
                new MemoryWriteAddress(0xf18000, 0xf19fff, qsound_sharedram_w), /* Q RAM */
    ...
    static InputPortPtr input_ports_forgottn = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_ghouls = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_strider = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_dwj = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_willow = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_unsquad = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_ffight = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_1941 = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_mercs = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_mtwins = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_msword = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_cawing = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_nemo = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_sf2 = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_3wonders = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_kod = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_captcomm = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_knights = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_varth = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_cworld2j = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_wof = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_dino = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_punisher = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_slammast = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_pnickj = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_qad = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_qadj = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_qtono2 = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_pang3 = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_megaman = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static InputPortPtr input_ports_sfzch = new InputPortPtr() {
        public void handler() {
            PORT_START();       /* IN0 */
    ...
    static RomLoadPtr rom_forgottn = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_lostwrld = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);
    ...
    static RomLoadPtr rom_ghouls = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);
    ...
    static RomLoadPtr rom_ghoulsu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);
    ...
    static RomLoadPtr rom_ghoulsj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);
    ...
    static RomLoadPtr rom_strider = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_striderj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_stridrja = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_dwj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_willow = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_willowj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_unsquad = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_area88 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_ffight = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_ffightu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_ffightj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_1941 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_1941j = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mercs = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mercsu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mercsj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mtwins = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_chikij = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_msword = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mswordu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mswordj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_cawing = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_cawingj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_nemo = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_nemoj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2a = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2b = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2e = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2j = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2jb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_3wonders = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_wonder3 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_kod = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_kodj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_kodb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_captcomm = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_captcomu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_captcomj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_knights = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_knightsj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2ce = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2cea = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2ceb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2cej = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2rb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2red = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2accp2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_varth = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_varthu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_varthj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_cworld2j = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_wof = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_wofj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2t = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sf2tj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_dino = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_dinoj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_punisher = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_punishru = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_punishrj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_slammast = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mbomberj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mbombrd = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_mbombrdj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_pnickj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_qad = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_qadj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_qtono2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_pang3 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_megaman = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_rockmanj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    static RomLoadPtr rom_sfzch = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(CODE_SIZE, REGION_CPU1);     /* 68000 code */
    ...
    public static InitDriverPtr init_wof = new InitDriverPtr() {
        public void handler() {
            wof_decode();
        }
    };

    public static InitDriverPtr init_dino = new InitDriverPtr() {
        public void handler() {
            dino_decode();
        }
    };

    public static InitDriverPtr init_punisher = new InitDriverPtr() {
        public void handler() {
            punisher_decode();
        }
    };

    public static InitDriverPtr init_slammast = new InitDriverPtr() {
        public void handler() {
            slammast_decode();
        }
    };

    public static InitDriverPtr init_pang3 = new InitDriverPtr() {
        public void handler() {
    ...
    public static GameDriver driver_sf2j = new GameDriver("1991", "sf2j", "cps1.java", rom_sf2j, driver_sf2, machine_driver_sf2, input_ports_sf2, null, ROT0, "Capcom", "Street Fighter II - The World Warrior (Japan 911210)");
    public static GameDriver driver_sf2jb = new GameDriver("1991", "sf2jb", "cps1.java", rom_sf2jb, driver_sf2, machine_driver_sf2, input_ports_sf2, null, ROT0, "Capcom", "Street Fighter II - The World Warrior (Japan 910214)");
    public static GameDriver driver_3wonders = new GameDriver("1991", "3wonders", "cps1.java", rom_3wonders, null, machine_driver_cps1, input_ports_3wonders, null, ROT0, "Capcom", "Three Wonders (US)");
    public static GameDriver driver_wonder3 = new GameDriver("1991", "wonder3", "cps1.java", rom_wonder3, driver_3wonders, machine_driver_cps1, input_ports_3wonders, null, ROT0, "Capcom", "Wonder 3 (Japan)");
    ...
    public static GameDriver driver_sf2cej = new GameDriver("1992", "sf2cej", "cps1.java", rom_sf2cej, driver_sf2ce, machine_driver_sf2, input_ports_sf2, null, ROT0, "Capcom", "Street Fighter II' - Champion Edition (Japan)");
    ...
    public static GameDriver driver_sf2tj = new GameDriver("1992", "sf2tj", "cps1.java", rom_sf2tj, driver_sf2ce, machine_driver_sf2, input_ports_sf2, null, ROT0, "Capcom", "Street Fighter II' Turbo - Hyper Fighting (Japan)");
