...
public class zaxxon
{
	...
	***************************************************************************/
	...
	{
		if (backgroundbitmap1 != null)  osd_free_bitmap(backgroundbitmap1);
		if (backgroundbitmap2 != null)  osd_free_bitmap(backgroundbitmap2);
	...
	***************************************************************************/
	...
	public static VhUpdatePtr zaxxon_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
	...
	public static VhUpdatePtr razmataz_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
