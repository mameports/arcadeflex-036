...
public class input {
 ...
 /* Subtype of codes */
    ...
    /* code not assigned */
    public static final int CODE_TYPE_KEYBOARD_OS = 1;
    /* os depend code */
    public static final int CODE_TYPE_KEYBOARD_STANDARD = 2;
    /* standard code */
    public static final int CODE_TYPE_JOYSTICK_OS = 3;
    /* os depend code */
    public static final int CODE_TYPE_JOYSTICK_STANDARD = 4;
...
//probably ok but throw an exception when you meet it so i can test it (shadow)
    ...
    static int[] record_seq = new int[SEQ_MAX];
    /* buffer for key recording */
    static int record_count;
    /* number of key/joy press recorded */
    static long record_last;
    /* time of last key/joy press */

    public static final int RECORD_TIME = (UCLOCKS_PER_SEC * 2 / 3);

    /* max time between key press */
