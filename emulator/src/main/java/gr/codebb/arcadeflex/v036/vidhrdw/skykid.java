...
public class skykid
{
	...
	static tilemap background;	/* background */
	static int game;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr get_tile_info_bg = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = row*64 + col;
		/*unsigned */char code = drgnbstr_videoram.read(tile_index);
		/*unsigned */char attr = drgnbstr_videoram.read(tile_index+0x800);
	...
	***************************************************************************/
	...
	public static VhStartPtr drgnbstr_vh_start = new VhStartPtr() { public int handler() 
	{
		game = 1;
		return skykid_drgnbstr_common_vh_init();
	} };
	...
	***************************************************************************/
	...
	public static VhUpdatePtr drgnbstr_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
