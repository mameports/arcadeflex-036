...
public class dec0
{
	...
	public static ReadHandlerPtr dec0_controls_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
			...
			case 8: /* Intel 8751 mc, Bad Dudes & Heavy Barrel only */
				//if (errorlog != 0) fprintf(errorlog,"CPU #0 PC %06x: warning - read unmapped memory address %06x\n",cpu_get_pc(),0x30c000+offset);
				return i8751_return;
		}
	...
	public static ReadHandlerPtr dec0_rotary_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
			...
			default:
				if (errorlog != null) fprintf(errorlog,"Unknown rotary read at 300000 %02x\n",offset);
		}
	...
	public static ReadHandlerPtr midres_controls_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
		...
		if (errorlog != null) fprintf(errorlog,"PC %06x unknown control read at %02x\n",cpu_get_pc(),0x180000+offset);
		return 0xffff;
	} };
	
	/******************************************************************************/
	
	public static ReadHandlerPtr slyspy_controls_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
			case 0: /* Dip Switches */
		...
		if (errorlog != null) fprintf(errorlog,"Unknown control read at 30c000 %d\n",offset);
		return 0xffff;
	} };
	...
	public static ReadHandlerPtr slyspy_protection_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (errorlog != null) fprintf(errorlog,"%04x, Unknown protection read at 30c000 %d\n",cpu_get_pc(),offset);
		return 0;
	} };
	...
	*/
	...
	public static WriteHandlerPtr slyspy_240000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"Wrote to 240000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_242000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"Wrote to 242000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_246000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"Wrote to 246000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_248000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"Wrote to 248000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_24c000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"Wrote to 24c000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_24e000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"Wrote to 24e000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	{
	//if (errorlog != 0) fprintf(errorlog,"6280 PC %06x - Read %06x\n",cpu_getpc(),offset+0x1d0000);
	...
	//if (errorlog != 0) fprintf(errorlog,"6280 PC %06x - Wrote %06x to %04x\n",cpu_getpc(),data,offset+0x1d0000);
	} };
	...
	static void hbarrel_i8751_write(int data)
	{
		...
		switch (data>>8) {
			...
			case 0x06:	/* Controls appearance & placement of special weapons */
				...
				//if (errorlog != 0) fprintf(errorlog,"CPU #0 PC %06x: warning - write %02x to i8751, returning %04x\n",cpu_get_pc(),data,i8751_return);
				break;
	...
	//if (errorlog != 0) fprintf(errorlog,"CPU #0 PC %06x: warning - write %02x to i8751\n",cpu_get_pc(),data);
	}
	...
	static void baddudes_i8751_write(int data)
	{
		...
		if (errorlog!=null && i8751_return==0) fprintf(errorlog,"%04x: warning - write unknown command %02x to 8571\n",cpu_get_pc(),data);
	}
	...
	static void birdtry_i8751_write(int data)
	{
		...
		if (errorlog != null) fprintf(errorlog,"%04x: warning - write unknown command %02x to 8571\n",cpu_get_pc(),data);
	...
	*/
	...
	if (errorlog != null) fprintf(errorlog,"i8751:  Timer called!!!\n");
	...
	public static void dec0_i8751_write(int data)
	{
		...
		if (i8751_timer != 0) {
			if (errorlog != 0) fprintf(errorlog,"i8751:  Missed a timer!!!\n");
		}
		else
	...
	*/
	...
	if (errorlog != null) fprintf(errorlog,"CPU #0 PC %06x: warning - write %02x to i8751\n",cpu_get_pc(),data);
	...
	public static WriteHandlerPtr sprite_mirror = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
