...
public class parodius
{
	...
	if (errorlog!=null && (lines & 0xf0)!=0) fprintf(errorlog,"%04x: setlines %02x\n",cpu_get_pc(),lines);
	...
	public static InitMachinePtr parodius_init_machine = new InitMachinePtr() { public void handler() 
	{
		UBytePtr RAM = memory_region(REGION_CPU1);
	...
	{
	if (errorlog!=null && (videobank & 0xf8)!=0) fprintf(errorlog,"%04x: videobank = %02x\n",cpu_get_pc(),data);
	...
	{
	if (errorlog!=null && (data & 0xf4) != 0x10) fprintf(errorlog,"%04x: 3fc0 = %02x\n",cpu_get_pc(),data);
	...
	public static WriteHandlerPtr sound_arm_nmi = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	//	sound_nmi_enabled = 1;
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_parodius = new InitDriverPtr() { public void handler() 
	{
