...
public class mappy
{
	...
	public static ReadHandlerPtr mappy_sharedram_r2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr digdug2_sharedram_r2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		/* to speed up emulation, we check for the loop the sound CPU sits in most of the time
		   and end the current iteration (things will start going again with the next IRQ) */
	...
	public static ReadHandlerPtr motos_sharedram_r2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		return mappy_sharedram.read(offset);
	} };
	
	public static ReadHandlerPtr todruaga_sharedram_r2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		return mappy_sharedram.read(offset);
	} };
	...
	public static WriteHandlerPtr mappy_customio_w_1 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		mappy_customio_1.write(offset,data);
	} };
	
	
	public static WriteHandlerPtr mappy_customio_w_2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr mappy_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr mappy_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr digdug2_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
				...
				switch (offset)
				{
					...
					case 1:		/* Start buttons, high nibble of port 4 */
					{
						...
						if ((val & 1)!=0 && ((val ^ lastval_4) & 1)!=0)
							if (credits >= credden_2[temp]) credits -= credden_2[temp];
						/* bit 1 is a trigger for the 2 player start */
						if ((val & 2)!=0 && ((val ^ lastval_4) & 2)!=0)
							if (credits >= 2 * credden_2[temp]) credits -= 2 * credden_2[temp];
	...
	public static ReadHandlerPtr digdug2_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		int mode = mappy_customio_2.read(8);
	...
	public static ReadHandlerPtr motos_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr motos_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		int mode = mappy_customio_2.read(8);
	...
	public static ReadHandlerPtr todruaga_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
				...
				switch (offset)
				{
					...
					case 1:		/* Start buttons, high nibble of port 5 */
					{
						...
						if ((val & 1)!=0 && ((val ^ lastval_7) & 1)!=0)
							if (credits >= credden_3[temp]) credits -= credden_3[temp];
						/* bit 1 is a trigger for the 2 player start */
						if ((val & 2)!=0 && ((val ^ lastval_7) & 2)!=0)
							if (credits >= 2 * credden_3[temp]) credits -= 2 * credden_3[temp];
	...
	public static ReadHandlerPtr todruaga_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		int mode = mappy_customio_2.read(8);
