...
public class ddrible
{
	...
	*******************************************************************/
	...
	public static WriteHandlerPtr ddrible_bank_select_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x02) != bankfg)
		{
	...
	public static WriteHandlerPtr ddrible_bank_select_w_2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr ddrible_fg_scrollx_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr ddrible_fg_scrolly_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		tilemap_set_scrolly(fg_tilemap,0,data);
	} };
        static int bg_scrollx;	
        
        public static WriteHandlerPtr ddrible_bg_scrollx_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr ddrible_bg_scrolly_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	...
	static void draw_sprites( osd_bitmap bitmap, UBytePtr source, int lenght, int gfxset )
	{
		...
		while (source.offset < finish)//( source < finish )
		{
			...
			int sx = source.read(3);					/* vertical position */
	...
	***************************************************************************/
	public static VhUpdatePtr ddrible_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
